              ...
              <div className="bg-blue-600 p-8 lg:p-12 text-white">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-blue-100">charles@cozyhomepartners.com</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold mb-2">Phone</h4>
                    <p className="text-blue-100">(816) 555-0123</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold mb-2">Service Areas</h4>
                    <p className="text-blue-100">Kansas City Metro & Surrounding Counties</p>
                  </div>
                </div>

                <div className="mt-12">
                  <h4 className="font-semibold mb-4">Why Choose Cozy Home Partners?</h4>
                  <ul className="space-y-2 text-blue-100">
                    <li>• Local Kansas City expertise</li>
