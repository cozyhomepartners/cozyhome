      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">2. Services Description</h2>
              <p className="text-ink mb-4">
                Cozy Home Partners provides real estate services including:
              </p>
              <ul className="list-disc pl-6 text-ink mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">3. Use License</h2>
              <p className="text-ink mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">4. Disclaimer</h2>
              <p className="text-ink mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibent text-ink mb-4">5. Limitations</h2>
              <p className="text-ink mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">6. Privacy Policy</h2>
              <p className="text-ink mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">7. Governing Law</h2>
              <p className="text-ink mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">8. Contact Information</h2>
              <p className="text-ink mb-4">
